...
('Natação', 'Esporte aquático focado em percorrer uma determinada distância na piscina no menor tempo possível.'),
('Judô', 'Arte marcial japonesa focada em projeções, imobilizações e chaves para subjugar o oponente.'),
('Queimada', 'Jogo recreativo e esportivo de equipe cujo objetivo é eliminar os integrantes do time adversário acertando-os com a bola.'),
('Vôlei', 'Esporte de rede disputado por duas equipes que usam as mãos e braços para passar a bola por cima da rede, buscando fazê-la tocar o chão da quadra adversária.');
